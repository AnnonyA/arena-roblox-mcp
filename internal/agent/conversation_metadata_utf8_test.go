...
func TestRunConversationRejectsInvalidUTF8ToolCallMetadataBeforeDispatch(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "id", id: "call-" + invalidUTF8, toolName: "script_read"},
		{name: "name", id: "call-valid", toolName: "script_" + invalidUTF8},
	}
