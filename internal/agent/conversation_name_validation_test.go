...
func TestRunConversationRejectsToolCallWithoutNameBeforeDispatch(t *testing.T) {
	...
	runRound := func(_ context.Context, _ []arena.Message) (arena.ChatResult, error) {
		return arena.ChatResult{ToolCalls: []arena.ToolCall{{ID: "call-empty-name", Type: "function", Function: arena.FunctionCall{Arguments: `{}`}}}}, nil
	}
